...
struct HelpLCCView: View {
    ...
    private var overviewCard: some View {
        helpCard(
            ...
            helpBullets([
                ...
                "Preferences define app behavior, project settings, volume presets, and configuration backups."
            ])
        }
    }
    ...
    private var preferencesCard: some View {
        helpCard(
            ...
            helpBullets([
                "App Preferences include time format, week start day, and Launch App at Startup.",
                ...
                "Launch App at Startup is a machine/user setting and is not included in project configuration exports."
            ])
        }
    }
